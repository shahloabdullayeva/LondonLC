...
import { ChevronLeft, ChevronRight, Clock, BarChart3, Lock } from "lucide-react";
...
const TEST_TYPE = "reading" as const;
                ...
                <button key={n} onClick={() => setSelectedBook(n)}
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 11, fontFamily: "var(--ff-mono)", color: "var(--text-3)", letterSpacing: "0.04em" }}>
                      {bookTests.length} reading test{bookTests.length !== 1 ? "s" : ""}
                    </div>
                  </div>
        ...
        <>
          ...
          {(() => {
            ...
            if (bookTests.length === 0) return (
              <p style={{ color: "var(--text-3)", fontSize: 14 }}>No reading tests available for this book yet.</p>
            );
            return (
