...
import { Send, Loader2, Download, RefreshCw, Pencil, PenLine } from "lucide-react";
...
function WritingPage() {
  ...
  return (
    <StudentShell>
      ...
      <h1 className="h1"><em>Writing</em></h1>
        ...
        <div>
          <div className="card" style={{ marginBottom: 20 }}>
            <div className="flex jcb aic" style={{ marginBottom: 12, gap: 12, flexWrap: "wrap" }}>
              <p className="eyebrow" style={{ margin: 0 }}>Prompt</p>
          ...
          <div className="editor">
            ...
            <div className="hd" style={{ borderTop: "1px solid var(--line)", borderBottom: 0 }}>
              <span style={{ fontSize: 11, color: "var(--text-3)" }}>
                {status === "grading" ? gradingStage : "Graded by Claude AI"}
              </span>
              <button
                className="btn primary sm"
